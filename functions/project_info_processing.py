...
def add_image_to_new_project(json_storage_file,  selected_project_to_edit, image_link, input_project_name_edit,input_hobby_name_edit,input_notes_edit, project_status_input_edit, input_links_edit, input_steps_taken_edit, input_steps_todo_edit):
...
def add_general_link_to_new_project(json_storage_file, selected_project_to_edit, url_link, input_project_name_edit,input_hobby_name_edit,input_notes_edit, project_status_input_edit, image_links_edit, steps_taken_edit, steps_todo_edit):
